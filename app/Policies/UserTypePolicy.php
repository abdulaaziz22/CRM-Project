...
class UserTypePolicy
{
    ...
    {
        return $user->hasPermission('show_UserType');
    }
    ...
    {
        return $user->hasPermission('create_UserType');
    }
    ...
    {
        return $user->hasPermission('update_UserType');
    ...
    {
        return $user->hasPermission('delete_UserType');
    }
